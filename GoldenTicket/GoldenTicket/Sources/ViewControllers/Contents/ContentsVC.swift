...
class ContentsVC: UIViewController, UICollectionViewDelegate {
    ...
    @IBAction func contentsOne(_ sender: Any) {
        ...
        let dvc = storyboard.instantiateViewController(withIdentifier: "contentsDetail2")
        present(dvc, animated: true)
    }
    
    @IBAction func contentsTwo(_ sender: Any) {
        let storyboard = UIStoryboard.init(name: "ContentsDetail", bundle: nil)
        let dvc = storyboard.instantiateViewController(withIdentifier: "contentsDetail")
        present(dvc, animated: true)
    }
}
