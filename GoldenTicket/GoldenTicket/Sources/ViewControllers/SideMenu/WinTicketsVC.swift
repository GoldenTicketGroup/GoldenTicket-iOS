...
extension InterestedVC
{
    func setWindata()
    {
        let win1 = Win(day: "2019년 06월 15일", title: "뮤지컬 벤허", price: "일반 R석 20,000원", location: "블루스퀘어 인터파크 홀", time: "17:00~19:00", winName: "posterMainBenhur")
        ...
        let win3 = Win(day: "2019년 12월 15일", title: "뮤지컬 인터스텔라", price: "일반 R석 10,000원", location: "올림픽공원 K-아트 홀", time: "11:00~13:00", winName: "posterMainBenhur")
